...
class webrtc_datachannels_conan_project(ConanFile):
    name = "webrtc_datachannels"
    ...
    description = "`webrtc_datachannels` library"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["webrtc_datachannels"]
